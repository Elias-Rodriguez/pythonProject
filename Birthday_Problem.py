"""
Write a program to demonstrate the number of people
needed to ensure that the probability at least two of them
have the same day of the year as their birthday
is at least50%,  70%, 80%, 90%, 95%, 98%, and at least 99%.
...
if __name__ == '__main__':
    people_in_room = int(input("Enter the amount of people in a room:"))
